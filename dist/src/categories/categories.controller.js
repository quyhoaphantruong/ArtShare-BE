...
__decorate([
    ...
    openapi.ApiResponse({ status: 201, type: require("./dto/response/category.dto").CategoryResponseDto }),
...
__decorate([
    (0, common_1.Get)(),
    openapi.ApiResponse({ status: 200, type: [require("./dto/response/category.dto").CategoryResponseDto] }),
    __metadata("design:type", Function),
