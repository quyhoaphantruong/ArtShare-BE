...
-- Insert Posts with thumbnail_url added
INSERT INTO public.post (user_id, title, description, thumbnail_url, is_published, is_private, group_id, share_count, comment_count)
VALUES
  (1, 'First Post', 'This is my first post!', 'https://example.com/thumbnail1.jpg', true, false, NULL, 10, 5),
  (2, 'Exploring Prisma', 'How to use Prisma with NestJS', 'https://example.com/thumbnail2.jpg', true, false, NULL, 8, 3);
